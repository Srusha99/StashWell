    ...
    try {
      ...
      program = new Program(gl, {
        ...
        uniforms: {
          ...
          uPoints: { value: Array(MAX_POINTS * 2).fill(0) },
      ...
      console.error('GlowCursor: failed to initialize WebGL, disabling effect', error);
      return;
    }

    const pointData = program.uniforms.uPoints.value;
